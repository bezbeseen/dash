      ...
      <div className="settings-sections">
        ...
        <section className="settings-section card border rounded-3 p-4 mb-3 bg-body">
          ...
          <p className="small text-body-secondary mb-3">
            ...
            Google Drive (job folders) and <strong>Google Calendar</strong> (the Calendar page). Reconnect the same
            mailbox after this ships so Calendar is on the token — it does not use a new slot. Enable{' '}
            <a
            ...
            on the same Cloud project as Gmail. After setting{' '}
            <code className="small">GOOGLE_DRIVE_*_FOLDER_ID</code>, reconnect so Drive scope is on the refresh token.
          </p>
          <GmailSidebarHint />
